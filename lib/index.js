/**
 * dsh-read-image host entry: the plugin is browser-side only. Nothing is
 ...
 * under /plugins/dsh-read-image/client.js.
 *
 ...
 *
 * @module dsh-read-image
 */
export const name = "dsh-read-image";
